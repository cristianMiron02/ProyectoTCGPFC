            ...
            {items.length === 0 ? (
                ...
                <>
                                        ...
                                        <tr key={item.id}>
                                            <td>
                                                <div className="d-flex gap-3 align-items-center">
                                                    <img src={item.imagen} alt={item.nombre} className="rounded" style={{ width: 96, height: 64, objectFit: "cover" }}/>
                                            ...
                                            <td className="text-end">
                                                <button className="btn btn-sm btn-outline-danger" onClick={() => confirmRemove(item)}>
                                                    Eliminar
                                                </button>
                                            </td>
                                        </tr>
                    ...
                    <div className="d-flex justify-content-end mt-3">
                        <div className="fs-5">
                            Total:{" "}
                            <span className="fw-bold">{total.toLocaleString("es-ES")} €</span>
                        </div>
                    </div>
                </>
            )}
